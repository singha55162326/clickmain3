...
<template>
    <vx-card title="Default" code-toggler>
        ...
        <ul class="demo-alignment">
            <li>
                <vs-radio v-model="radios1" vs-value="luis">Btn1</vs-radio>
            </li>
            <li>
                <vs-radio v-model="radios1" vs-value="carols">Btn2</vs-radio>
            </li>
            <li>
                <vs-radio v-model="radios1" vs-value="summer">Btn3</vs-radio>
            </li>
            <li>
